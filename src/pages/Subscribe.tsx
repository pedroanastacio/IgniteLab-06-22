    ...
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat filter flex flex-col items-center">
      <div className="flex items-center justify-between w-full max-w-[1100px] mt-20 mx-auto">
        <div className="max-w-[640px]">
          ...
          <h1 className="mt-8 text-[2.25rem] leading-tight">
            Construa uma
            <strong className="text-orange-500">aplicação completa</strong>, do
            zero, com <strong className="text-orange-500">React</strong>
          </h1>
