      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          ...
          <div className="flex flex-col gap-4">
            <a
              href=""
              className="p-4 text-sm text-gray-600 bg-yellow-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-yellow-700 transition-colors"
            >
              <DiscordLogo size={24} />
            ...
            <a
              href=""
              className="p-4 text-sm border border-green-500 text-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-500 hover:text-gray-900 transition-colors"
            >
              <Lightning size={24} />
              Acesse o desafio
            </a>
